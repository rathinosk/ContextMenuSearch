...
function generateSearchEngineList() {
    const searchEngines = [
        ...
        { category: "Web search", name: "Dogpile", link: "https://www.dogpile.com/serp?q=TESTSEARCH" },
        { category: "Web search", name: "Metacrawler", link: "https://www.metacrawler.com/serp?q=TESTSEARCH" },
        ...
        { category: "Shopping", name: "Amazon US", link: "https://www.amazon.com/s?k=TESTSEARCH" },
        ...
        { category: "Shopping", name: "Best Buy", link: "https://www.bestbuy.com/site/searchpage.jsp?st=TESTSEARCH" },
        { category: "Shopping", name: "Newegg", link: "https://www.newegg.com/p/pl?d=TESTSEARCH" },
        ...
        { category: "Shopping", name: "Google Shopping", link: "http://www.google.com/products?q=TESTSEARCH&aq=f" },
        { category: "Shopping", name: "Bing Shopping", link: "https://www.bing.com/shop?q=TESTSEARCH&qs=n&form=QBRE" },
        { category: "Shopping", name: "Yahoo Shopping", link: "http://search.yahoo.com/search?vc=&p=TESTSEARCH" },
        { category: "Social Search", name: "Facebook", link: "https://www.facebook.com/search/top/?q=TESTSEARCH" },
        ...
        { category: "Social Search", name: "Instagram", link: "https://www.instagram.com/explore/search/keyword/?q=TESTSEARCH" },
        ...
        { category: "Music & Movies", name: "Rotten Tomatoes", link: "https://www.rottentomatoes.com/search?search=TESTSEARCH" },
        ...
        { category: "Gaming Search", name: "Epic Games", link: "https://store.epicgames.com/en-US/expanded-search-results?q=TESTSEARCH" },
        ...
        { category: "Other", name: "Wayback Machine", link: "https://web.archive.org/web/*/TESTSEARCH" },
